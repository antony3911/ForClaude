...
> **國家權重**：美國 ≫ 日本 ≳ 其他英語系國家（美國遠高於所有國家；日本只略高於其他國家）；台灣的選項也保留。歐陸的有薪 PhD 已移到 [archive](archive/)。
> **核心發現**：
> 1. **這些國家的 PhD 大多有資助**：美國全額、日本有交流協會獎學金、英國 UKRI 有 30% 名額給國際生、加拿大與澳洲的研究型學位都有生活津貼
...
| | 🇺🇸 美國 | 🇯🇵 日本 | 🇬🇧 英國 | 🇨🇦 加拿大 | 🇦🇺 澳洲 | 🇹🇼 台灣 |
|---|---|---|---|---|---|---|
| 年限 | 5–6 年 | **博士 3 年**（已有碩士） | **3–4 年**（通常要先有碩士） | 約 4 年（也可以先讀 MASc） | 3–4 年 | 4–6 年 |
| 資助 | 通常全額（RA／TA），年薪約 US$3–5 萬多 | **交流協會獎學金**：學費、往返機票，外加每月生活費（碩士 ¥144,000；博士的金額見簡章） | **UKRI 獎學金**：2026/27 年最低生活津貼 £21,805（倫敦 £23,805）；最多 30% 名額給國際生；**學費只補到本地生水準，差額要逐校確認** | 例如 UofT ECE：補學費，另給每年最低生活津貼（MASc 為 CAD 20,500；PhD 的金額另查） | **RTP 獎學金（不限國籍）**：2026 年每年約 A$3.4–4.3 萬 | 企業與學校獎學金，每月約 3–6 萬元不等 |
| 頂尖獎學金 | Knight-Hennessy（史丹佛） | 交流協會（台灣人專屬） | Gates Cambridge、Clarendon（牛津） | — | — | 聯電、台積電博士獎學金 |
| 晶片產業 | 世界中心 | 復興中；有 AI 晶片公司 | Arm 等 | Toronto 聚落 | 少 | **世界中心之一** |
| 適合你嗎 | 需要頂尖研究紀錄 | **有全英語的博士班；AI 晶片研究有實力** | **你已經有碩士，3–4 年就能完成** | **UofT 是 FPGA 研究重鎮** | 研究資助好，但產業弱 | 留在熟悉的研究圈 |
...
- **對你來說更實際的順序**：先讀美國 MS，在 MS 期間做研究、和教授合作，表現好再申請 PhD（或者在 MS 期間找到願意收你的教授直接轉）
- **其他國家的研究經歷可以幫你申請美國 PhD**：在日本、加拿大、英國的實驗室發表論文，是很有力的申請素材

### 🇯🇵 日本（美國以外的備選，略優先）
- **全英語的博士班**：東京大學工學系研究科的 Special English Graduate Programs、東京科學大學的 International Graduate Program（沒有日語要求，但要先找到指導教授）。見 [02](02-study-abroad-by-country.md)
- **資助**：交流協會獎學金同樣適用博士（學費、機票加每月生活費）
- **和你背景相關的日本實驗室（範例）**：

| 教授 | 學校 | 研究 | 和你的關係 |
|---|---|---|---|
| **本村真人（Masato Motomura）** | 東京科學大學 | **深度神經網路加速器**；曾參與 eDRAM 與 FPGA 混合架構；帶領團隊做出 AI 加速晶片 **Hiddenite** | **日本做 AI 加速器晶片最具代表性的實驗室之一** |
| **天野英晴、近藤正章（Amano-Kondo Lab）** | 慶應義塾大學 | FPGA 應用加速、多 FPGA 系統、用 FPGA 降低 GPU 之間的通訊延遲 | **和你的 FPGA 背景直接對口**；天野教授也寫過 FPGA 的教科書 |
| **井上弘士（Koji Inoue）** | 九州大學 | 計算機結構、FPGA 加速器 | 計算機結構與硬體加速（實驗室細節待查） |

- **產學合作**：Preferred Networks 的 MN-Core 晶片是和**神戶大學**合作開發的
- **畢業後**：日本的博士學歷在高度專門職簽證有 30 點，是永久居留最快的路之一（見 [01](01-work-first.md)）
...
- **這是「主動提升」加上「海外經驗」的低成本組合**：你可以去美國、日本、英國、加拿大的頂尖實驗室，還能拿到國外教授的推薦信；**以你的權重，首選是美國的實驗室**
...
| **Preferred Networks、EdgeCortix 等** | 日本東京 | ✅ | 日本的 AI 晶片公司，研發職位不一定要博士（見 [01](01-work-first.md)） |
...
1. **如果要讀博，美國仍是首選**，但更實際的做法是「先 MS、再看要不要 PhD」
2. **美國以外，日本的博士班值得知道**：有全英語課程、交流協會獎學金、做 AI 加速器的強實驗室（例如本村真人），而且博士畢業後在日本拿永久居留很快
3. **英國 PhD 對你特別有效率**：你已經有碩士，3–4 年就能拿到博士，畢業後還有 3 年的工作簽證；搭配 Gates 或 Clarendon 更好
4. **加拿大 UofT 可以「先 MASc、再 PhD」**：有資助、FPGA 研究頂尖、移民路徑清楚
5. **「台灣博士 + 千里馬」**是另一種低成本的主動提升路線，而且可以留在熟悉的研究圈
6. **教職不要當成預設目標**：先確認自己是真心喜歡教學與研究

---

## 來源
- 日本：[東京科學大學：本村真人](https://search.star.titech.ac.jp/titech-ss/pursuer.act?event=outside&key_rid=B000226523&lang=en)、[AI Computing Research Unit：Prof. Masato Motomura](http://www.artic.iir.titech.ac.jp/wp/en/people_backup/prof-motomura/)、[Mirage News：Hiddenite AI 處理器](https://www.miragenews.com/new-ai-processor-for-reduced-computational-728030/)、[慶應 Amano-Kondo Lab](https://www.am.ics.keio.ac.jp/wp/)、[慶應：天野英晴](https://k-ris.keio.ac.jp/html/100011733_en.html)、[九州大學：井上弘士](https://hyoka.ofc.kyushu-u.ac.jp/html/100021341_en.html)、[Science Tokyo：IGP](https://admissions.isct.ac.jp/en/013/graduate/programs/science-and-engineering)、[交流協會：日本獎學金](https://www.koryu.or.jp/tw/business/scholarship/)、[PFN：MN-Core L1000](https://www.preferred.jp/en/news/pr20241115)
