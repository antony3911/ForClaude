...
### 第 7 章　指令手冊
7.1 指令格式（選項、參數、管線、導向、變數、按鍵）
7.2 Linux 基本操作　7.3 環境調查與設定　7.4 Git　7.5 tmux
7.6 本專案的 make 指令（目標、變數、各實驗的指令組合）
7.7 Vitis 原始指令　7.8 看結果　7.9 host 與 Python 參數
7.10 實際執行過的指令時間軸　7.11 常見錯誤與排查
