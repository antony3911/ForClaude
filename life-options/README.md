...
> 最後更新：2026-09-26（v3.1：國家權重為美國遠高於所有國家，日本略高於其他國家）
> 起點：中山電機所碩二、數位 IC 與 AI 加速器背景、民國 92 年次役男、對寫作有興趣。
> **你的篩選原則**：
> 1. **主動提升**：出國要是一段主動提升自我的過程（學位、研究、課程、語言學校、頂尖獎學金），不是「人在國外、被動吸收」（所以不考慮打工度假）
> 2. **國家權重：美國 ≫ 日本 ≳ 其他英語系國家**：**美國遠高於所有國家**；日本只**略高於**其他英語系國家（英、加、澳、愛爾蘭、紐西蘭；新加坡為邊界選項）
>
> 不符合條件的舊內容（打工度假、歐陸、韓國）在 [archive](archive/)。

## 這份資料和 `study-abroad-manual/` 的關係
...
| # | 章節 | 內容 |
|---|---|---|
| 00 | [思考框架](00-frameworks.md) | 你的篩選原則與國家權重；把「一條路」拆成三件事；Odyssey Plan；職涯資本；可逆性；六個自我提問 |
| 01 | [先工作](01-work-first.md) | 台灣的工作地圖與薪資；外商轉調美國；**日本的 AI 晶片公司、薪資、高度專門職簽證**；各國畢業後的工作權 |
| 02 | [美國、日本與其他英語系國家](02-study-abroad-by-country.md) | 美、日、英、加、澳、愛爾蘭、紐西蘭、新加坡的學費、資助、畢業後工作權、晶片產業；**日本的英語研究所與交流協會獎學金** |
| 03 | [讀博、教職、研究員](03-phd-and-research.md) | 美、日、英、加、澳的有資助 PhD；**日本的 AI 硬體實驗室**；台灣博士與出國研究；教職的現實；研究員職位 |
...
- 這份探索還在持續進行中（每天早上自動探索一個主題，**先做美國的項目，之後才是日本與其他國家**），進度與待探索清單見 [WORKLOG](WORKLOG.md)
