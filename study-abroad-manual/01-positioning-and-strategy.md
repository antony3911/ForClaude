...
> ⚠️ **畢業後就用不到學校的 EDA 工具和 TSRI 資源了，這一節的階段 1–2 一定要在碩二（2027/06 前）完成。**
...
兵役   ：2027 畢業 → 優先入營服完 4 個月 → 台灣業界工作 1.5 年 → 2029 Fall 入學
研究   ：做完並投稿 → SOP 的差異化、面試話題、保留 PhD 的可能
補強   ：ASIC flow（PPA 數字，碩二就要做完）+ 驗證 + RTL 面試能力 + 台灣業界經驗
